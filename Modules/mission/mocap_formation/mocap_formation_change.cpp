/*******************************************************************
 * 文件名:mocap_formation_change.cpp
 * 
 * 作者: BOSHEN97
 * 
 * 更新时间: 2020.10.14
...
//打印集群队形状态函数
void mocap_formation::printf_formation_type(std::string type_name)
{
    std::cout << std::endl;
...
{
    ros::init(argc, argv, "mocap_formation_change");
