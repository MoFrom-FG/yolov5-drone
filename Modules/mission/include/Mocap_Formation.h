...
/*******************客户端*******************/
        ...
        //1号机模式切换客户端
        ros::ServiceClient uav1_mode_client;

        //2号机模式切换客户端
        ros::ServiceClient uav2_mode_client;

        //3号机模式切换客户端
        ros::ServiceClient uav3_mode_client;

        //4号机模式切换客户端
        ros::ServiceClient uav4_mode_client;

        //5号机模式切换客户端
        ros::ServiceClient uav5_mode_client;

        //1号机解上锁客户端
        ros::ServiceClient uav1_arm_client;

        //2号机解上锁客户端
        ros::ServiceClient uav2_arm_client;

        //3号机解上锁客户端
        ros::ServiceClient uav3_arm_client;

        //4号机解上锁客户端
        ros::ServiceClient uav4_arm_client;

        //5号机解上锁客户端
        ros::ServiceClient uav5_arm_client;
...
/*******************变量*******************/
        ...
        //1号机飞行模式
        mavros_msgs::SetMode uav1_mode;

        //2号机飞行模式
        mavros_msgs::SetMode uav2_mode;

        //3号机飞行模式
        mavros_msgs::SetMode uav3_mode;

        //4号机飞行模式
        mavros_msgs::SetMode uav4_mode;

        //5号机飞行模式
        mavros_msgs::SetMode uav5_mode;

        //1号机解上锁
        mavros_msgs::CommandBool uav1_arm;

        //2号机解上锁
        mavros_msgs::CommandBool uav2_arm;

        //3号机解上锁
        mavros_msgs::CommandBool uav3_arm;

        //4号机解上锁
        mavros_msgs::CommandBool uav4_arm;

        //5号机解上锁
        mavros_msgs::CommandBool uav5_arm;
